...
<!-- Shoping Cart -->
<form class="bg0 p-t-75 p-b-85 m-t-70 m-t-70">
	<div class="container">
		<div class="row">
			<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
			<?php
...
=======
							...
							?>
									...
									<tr class="table_row">
										...
										<td class="column-1">
											<div class="how-itemcart1">
												<img src="<?php echo $proImageRef . $proCartData['pImage'] ?>" alt="IMG">
											</div>
										</td>
										<td class="column-2"><?php echo $proCartData["pName"] ?></td>
										<td class="column-3">$ <?php echo $proCartData["pPrice"] ?></td>
...
<<<<<<< HEAD
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					...
					?>
						<a href="register.php" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">Proceed to Checkout</a>
					<?php
					} else {
					?>
...
=======
					<h2 class="ltext-105 cl0 txt-center text-dark">
						0 Item found, Add Product Into Cart
>>>>>>> 700f3cd9ea2bb8a3c086ee8c7ad0b8654a6b338e
					</h2>
				<?php
				}
